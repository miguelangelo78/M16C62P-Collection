#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/motor/motor_sound.c"

#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/motor/../init/sfr62p.h"
...
#line 2 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/motor/motor_sound.c"
...
#line 3 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/motor/motor_sound.c"
...
#line 4 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/motor/motor_sound.c"
...
void motor_tone_us(int pitch, int duration_us) {
	...
	if(pitch > 500 || pitch < 0 ) return;

	for(; duration_us; duration_us--) {
		 
		TA1IC_ADDR.BYTE = 0;
		TA1MR_ADDR.BYTE = 0x42;
		TA1_ADDR = 0x02;
		TABSR_ADDR.BIT.B1	  = 1;
		ONSF_ADDR.BIT.B1	  = 1;
		...
		for(;;) {
			...
			P7_ADDR.BIT.B6		  = 1; P8_ADDR.BIT.B0		  = 0; for(i=0;i<pitch;i++);; P7_ADDR.BIT.B6		  = 0; P8_ADDR.BIT.B0		  = 1; for(i=0;i<pitch;i++);; ;
			
			 
			if(TA1IC_ADDR.BIT.B3	  ) break;
		}
		TABSR_ADDR.BIT.B1	  = 1;
	}
	
	P7_ADDR.BIT.B6		  = P8_ADDR.BIT.B0		  = 0; ;	
}
...
void init_motor_sound(void) {
	...
	oldreg_dir[0] = P7D_ADDR.BIT.B6		  ;
	oldreg_dir[1] = P8D_ADDR.BIT.B0		  ;
	oldreg[0] = P7_ADDR.BIT.B6		  ;
	oldreg[1] = P8_ADDR.BIT.B0		  ;
	
	 
	P7D_ADDR.BIT.B6		  = P8D_ADDR.BIT.B0		  = 1;
}

void deinit_motor_sound(void) {
	 
	P7D_ADDR.BIT.B6		  = oldreg_dir[0];
	P8D_ADDR.BIT.B0		  = oldreg_dir[1];
	P7_ADDR.BIT.B6		  = oldreg[0];
	P8_ADDR.BIT.B0		  = oldreg[1];
}
