#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/7seg/7segment.c"

#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/7seg/../init/sfr62p.h"
...
#line 2 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/7seg/7segment.c"
...
void init_7seg() {
	...
	P4D_ADDR.BIT.B2		  = 1; P4_ADDR.BIT.B2		  = 1; ;
	P4D_ADDR.BIT.B3		  = 1; P4_ADDR.BIT.B3		  = 1; ;
}
...
void seg_update(unsigned char n) {
	...
	P4_ADDR.BIT.B2		  = 0;; P4D_ADDR.BIT.B3		  = 1; P4_ADDR.BIT.B3		  = 1;; P5_ADDR.BYTE = bin_2_bcd((n & 0xF0) >> 4); for(i=0;i<300;i++);;	 ;
	 
	P4_ADDR.BIT.B3		  = 0;; P4D_ADDR.BIT.B2		  = 1; P4_ADDR.BIT.B2		  = 1;; P5_ADDR.BYTE = bin_2_bcd(n & 0xF); for(i=0;i<300;i++);;	 ;
}
