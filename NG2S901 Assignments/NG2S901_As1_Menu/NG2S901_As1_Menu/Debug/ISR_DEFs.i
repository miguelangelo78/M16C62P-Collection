#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/isr/ISR_DEFs.c"

#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/isr/../init/sfr62p.h"
...
#line 2 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/isr/ISR_DEFs.c"
...
isr_cback_t isr_callbacks[3 ];

void uninstall_all_cback(void) {
	char i;
	for(i=0;i<3 ;i++) isr_callbacks[i] = 0;
}
...
void set_isr_priority(char cback_index, char installing) {
	switch(cback_index) {
	case 0: INT0IC_ADDR.BYTE = installing ? priority_counter : 0; break;
	case 1: INT1IC_ADDR.BYTE = installing ? priority_counter : 0; break;
	case 2:  
		ADCON0_ADDR.BYTE = 0x05;
		ADCON1_ADDR.BYTE = 0x28;
		ADCON2_ADDR.BYTE = 0x05;
		_asm("fclr i");	
		ADIC_ADDR.BYTE = 0x04;
		_asm("fset i");
