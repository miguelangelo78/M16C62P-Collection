#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/timer/timer.c"

#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/timer/../init/sfr62p.h"
...
#line 2 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/timer/timer.c"
...
#line 3 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/timer/timer.c"
...
#line 4 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/timer/timer.c"

timer_cback_t timer_cback_list[8 ];
...
void timer_init(
	...
	timer_period = ((unsigned short) (((24000000 / cpu_div) * (timer_period/1000 + 0.00318)) - 1)) ;
	...
	switch(timer_index) {
		case TIMERA0:  
			...
			break;
		case TIMERA1:
			TA1MR_ADDR.BYTE = timer_config;
			TA1IC_ADDR.BYTE = timer_priority;
			TA1_ADDR = timer_period;
			TABSR_ADDR.BIT.B1	  = 1;
			break;
		case TIMERA2: 
			TA2MR_ADDR.BYTE = timer_config;
			TA2IC_ADDR.BYTE = timer_priority;
			TA2_ADDR = timer_period;
			TABSR_ADDR.BIT.B2	  = 1;
			break;
		case TIMERA3:
			TA3MR_ADDR.BYTE = timer_config;
			TA3IC_ADDR.BYTE = timer_priority;
			TA3_ADDR = timer_period;
			TABSR_ADDR.BIT.B3	  = 1;
			break;
		case TIMERA4: 
			TA4MR_ADDR.BYTE = timer_config;
			TA4IC_ADDR.BYTE = timer_priority;
			TA4_ADDR = timer_period;
			TABSR_ADDR.BIT.B4	  = 1;
			break;
		case TIMERB0:
			TB0MR_ADDR.BYTE = timer_config;
			TB0IC_ADDR.BYTE = timer_priority;
			TB0_ADDR = timer_period;
			TABSR_ADDR.BIT.B5	  = 1;
			break;
		case TIMERB1:
			TB1MR_ADDR.BYTE = timer_config;
			TB1IC_ADDR.BYTE = timer_priority;
			TB1_ADDR = timer_period;
			TABSR_ADDR.BIT.B6	  = 1;
			break;
		case TIMERB2: 
			TB2MR_ADDR.BYTE = timer_config;
			TB2IC_ADDR.BYTE = timer_priority;
			TB2_ADDR = timer_period;
			TABSR_ADDR.BIT.B7	  = 1;
			break;
		default: break;  	
	}
