#line 1 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/init/hwsetup.c"
...
#line 2 "C:/Users/Miguel/Desktop/Nova pasta/NG2S901_As1_Menu/NG2S901_As1_Menu/drivers/init/hwsetup.c"
...
{    
	...
	PM1_ADDR.BIT.B0		  = 1;		
	PRCR_ADDR.BIT.B1	  = 0;
	P0_ADDR.BYTE =P1_ADDR.BYTE =P2_ADDR.BYTE =P3_ADDR.BYTE =P4_ADDR.BYTE =P5_ADDR.BYTE =P6_ADDR.BYTE =P7_ADDR.BYTE =P9_ADDR.BYTE =P10_ADDR.BYTE =0X0;       
	P4_ADDR.BYTE = 0X0F;
	P1D_ADDR.BYTE =P2D_ADDR.BYTE =P3D_ADDR.BYTE =P4D_ADDR.BYTE =P5D_ADDR.BYTE =P6D_ADDR.BYTE =0xFF;
	PRCR_ADDR.BIT.B2	  =1;
	P9D_ADDR.BYTE =0xFF;
	PRCR_ADDR.BIT.B2	  =0;
	P6D_ADDR.BYTE |= 0x0F;
	P8_ADDR.BIT.B0		  = P8_ADDR.BIT.B1		  = 0;
	P8D_ADDR.BIT.B0		  = P8D_ADDR.BIT.B1		  = 1;	
	P3D_ADDR.BYTE =0xFF;
	
	TA0MR_ADDR.BYTE =0x80;
	TA0_ADDR =20000;
	TA0IC_ADDR.BYTE =0x04;
	
	asm("FSET I") ;
	
	TABSR_ADDR.BYTE =0x07;
